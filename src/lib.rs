// src/lib.rs
/*
 * Core library for ManagementConsole
 */
...
#[derive(Debug)]
pub struct ManagementConsoleProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ManagementConsoleProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ManagementConsole processing");
    
    let mut processor = ManagementConsoleProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ManagementConsoleProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ManagementConsoleProcessor::new(false);
